...
const Dashboard = () => {
  ...
  const [re, setRefresh] = useState(false);
  ...
  return (
    <>
        ...
        <div className="div">
        <div className="text-wrapper">Project Manager
        <Link to='/'>
          ...
          <div className="container">
            <div className="box">
              ...
              <div className="box-project" key={elem._id}>
                <div className="text-wrapper-3">{elem.nameProject}</div>
                <p className="due">
                  <span className="span">Due : </span>
                  <span className="text-wrapper-4">{elem.Date}</span>
                </p>
                <button onClick={(e)=> goToProgress(elem._id)} className="frame-2S">
                  <div className="text-wrapper-5">Start Project</div>
            ...
            <div className="box">
              ...
              <div className="box-project" key={elem._id}>
                ...
                <button onClick={(e)=> goToCompleted(elem._id)} className="frame-2">
                  <div className="text-wrapper-5">Move to completed</div>
                  <div className="text-wrapper-6">&gt;</div>
                </button>
              </div>
              )}
            ...
            <div className="box">
              ...
              <div className="box-project" key={elem._id}>
                ...
                <button  onClick={(e)=> goToRemove(elem._id)}  className="frame-2R">
                  <div className="text-wrapper-5">X remove project</div>
                </button>
              </div>
              )}
              </div>
