...
/>
            ...
            <div className="frame-3P">
              ...
              {msgDate ?
              <TextField sx={{width:'500px'}} type='date'
                         helperText={form.Date !== undefined ? setMsgDate(false) : validationDate}
                         error
        name='Date'
        onChange={(e) => handleChange(e)}
      />
...
/>      
            ...
            <div className="div-wrapperP">
              <button type='submit' className="text-wrapper-4P">Plan Project</button>
            </div>
                 }
          </div>
